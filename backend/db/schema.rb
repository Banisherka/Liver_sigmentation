...
ActiveRecord::Schema[7.2].define(version: 2025_11_19_015247) do
  ...
  create_table "ct_scans", force: :cascade do |t|
    t.string "patient_id"
    t.text "dicom_series"
    t.date "study_date"
  ...
  create_table "segmentation_results", force: :cascade do |t|
    t.bigint "segmentation_task_id"
    t.string "mask_file"
    t.jsonb "contours"
    t.jsonb "metrics"
    t.decimal "volume_ml"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["segmentation_task_id"], name: "index_segmentation_results_on_segmentation_task_id"
  end

  create_table "segmentation_tasks", force: :cascade do |t|
    t.bigint "ct_scan_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ct_scan_id"], name: "index_segmentation_tasks_on_ct_scan_id"
  end
